...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _OrderFormSender = __webpack_require__(6);

	var _OrderFormSender2 = _interopRequireDefault(_OrderFormSender);

	var _ContactsStorage = __webpack_require__(8);
	...
	var OrderFormSender = function () {
	    ...
	    _createClass(OrderFormSender, [{
	        ...
	        value: function showPopup() {
	            ...
	            (0, _jquery2.default)("#order-popup .order-popup__title").text("Отправка заказа");
	        ...
	        value: function parseForm() {
	            ...
	            function onComplete() {
	                var sum = (0, _jquery2.default)(".table-item__summ").text();
