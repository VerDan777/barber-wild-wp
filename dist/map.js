...
/***/ (function(module, exports, __webpack_require__) {
	...
	window.initMap = function () {
	    ...
	    // Parse external JSON
	    _jquery2.default.getJSON('google.json', function (data) {
	        _jquery2.default.each(data, function (i, value) {
	            ...
	            function handleLocationError(browserHasGeolocation, infowindow, pos) {
	                ...
	                infowindow.setContent(browserHasGeolocation ? 'Ваше местоположение не найдено.' : 'Ваше бразер не поддерживает геолокацию.');
	            }
	            ...
	            var TableItem = (0, _jquery2.default)(".table-item");
	            TableItem.on('click', function (e) {
	                e.preventDefault();
	                var idToFind = (0, _jquery2.default)(this).data("title");
	            ...
	            var Phone = (0, _jquery2.default)(".table-item__phone-container");
	...
	(function () {
	    ...
	    button.click(function () {
	        ...
	        (0, _jquery2.default)("html, body").animate({ scrollTop: 1000 }, 600);
	    });
	    ...
	    (0, _jquery2.default)(window).scroll(function () {
	        if ((0, _jquery2.default)(document).scrollTop() < 800) {
